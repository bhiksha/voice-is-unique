...
def main(args):
    ...
    train.test_textgrids(test_loader, test_model, criterion, device,args.window_size, test_dataset.has_textgrids, args.output_dir, tv=args.tv,tc=args.tc, custom=args.custom)
